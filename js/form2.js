window.cfields = { "1": "utmsource", "2": "utmmedium", "3": "utmcampaign", "4": "utmterm", "5": "utmcontent" };
...
(function () {
    ...
    var _removed = false;
    var form_to_submit = document.getElementById('form_6');
    ...
    var form_submit = function (e) {
        ...
        if (validate_form()) {
            ...
            var serialized = form_serialize(document.getElementById('_form_6')).replace(/%0A/g, '\\n');
            var err = form_to_submit.querySelector('._form_error');
            err ? err.parentNode.removeChild(err) : false;
            _load_script('https://jeanfagrdg.activehosted.com/proc.php?' + serialized + '&jsonp=true');
        }
        return false;
    };
